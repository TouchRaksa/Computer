...
import { desktop_images } from "../assets/Image/Desktop"; // make sure this is an array of desktop images
import Footer from "./Footer";

function Desktop({ search = "" }) {
  const navigate = useNavigate();

  // Build products array with detail
  const products = desktop_images.map((img, index) => ({
    name: `Desktop ${index + 1}`,
    price: 250 + index * 20,
    image: img,
    category: "desktop",
    detail: `This is Desktop ${index + 1}. High-performance desktop suitable for gaming and work.`,
  }));
